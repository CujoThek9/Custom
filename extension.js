(function () {
				...
				if (!bot.commands.executable(this.rank, chat)) return void (0);
					...
					switch (randomInt) {
						case 1:
							...
							break;
						case 2:
							API.sendChat("@" + randomUser + ", how do you like The Dogg Pound?");
							break;
						case 3:
				...
				if (!bot.commands.executable(this.rank, chat)) return void (0);
					...
					switch (randomInt) {
						...
						case 3:
							...
							break;
						case 4:
							API.sendChat("@" + chat.un + ", you do know you're talking to a Dogbot?");
							break;
						case 5:
							API.sendChat("@" + chat.un + ", Woof Woof!");
							break;
					}	
				}
			}
    ...
    $.getScript("https://rawgit.com/cujothek9/source/master/cujothek9.js", extend);
